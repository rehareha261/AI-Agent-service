    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(state: Dict[str, Any]) -> Dict[str, Any]:
            ...
            try:
                ...
                if task_run_id and db_persistence.pool is not None:
                ...
                elif task_run_id and db_persistence.pool is None:
                ...
                if step_id and db_persistence.pool is not None:
                ...
                elif step_id and db_persistence.pool is None:
